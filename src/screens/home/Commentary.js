...
import {plotinus_e3_c8_commentary_by_para, plotinus_e3_c8_eng_text} from '../../data/data'
import { Extrapolate, interpolate, useValue } from 'react-native-reanimated';
import TextHelper from '../../helpers/TextHelper';
const Commentary = ({ paragraphIndex }) => {
  // hooks
  ...
  let title = `Para. ${TextHelper.romanize(paragraphIndex+1)} Commentary`;
  let text = plotinus_e3_c8_commentary_by_para[paragraphIndex];
    ...
    <View style={styles.container}>
      <BottomSheet
        ...
        handleComponent={()=><Animated.View style={{...styles.handleContainer, marginBottom: 0}}>
            ...
            <Text style={{...Fonts.Bold(15), color: 'white'}}>{title}</Text>
        </Animated.View>}
      >
